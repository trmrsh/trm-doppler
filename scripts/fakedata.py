...
parser.add_argument('-nw', type=int,   default=1200, help='Number of wavelengths')
parser.add_argument('-t1', type=float, default=50000.0, help='First time')
parser.add_argument('-t2', type=float, default=50000.1, help='Last time')
...
data.wfits(doppler.afits(args.fake))
