...
usage = \
"""
vrend uses the s2plot 3D plotting package to provide a volume rendering
of a 3D image. This will only work if s2plot and the python extension are
installed of course
"""
...
vro = ns2cvr(data, nx, ny, nz, 0, nx-1, 0, ny-1, 0, nz-1,
...
s2funuva(lambda u, v: u, lambda u, v: v, lambda u, v: 0, lambda u, v: 0.5,
