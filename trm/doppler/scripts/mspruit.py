...
# optional
parser.add_argument('-d', dest='dop', default='dop.out',
                    help='name of file containing the Spruit map')
parser.add_argument('-f', dest='fwhm', type=float, default=300.,
                    help='FWHM of gaussian default')
parser.add_argument('-t', dest='tzero', type=float, default=0.,
                    help='tzero of ephemeris to be stored in map')
parser.add_argument('-p', dest='period', type=float, default=0.1,
...
image = doppler.Image(mp, doppler.PUNIT, vxy, w0, 0., doppler.Default.gauss2d(1., args.fwhm))
